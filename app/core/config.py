...
class Settings(BaseSettings):
    ...
    hf_qdrant_collection: str = "rag_chunks_hf"
    force_hf_retrieval_collection: bool = True
    vector_distance: str = "cosine"
    vector_query_limit: int = 8
    bm25_k1: float = 1.5
    bm25_b: float = 0.75
    enable_hf_chunk_enrichment: bool = False
    hf_topic_model_name: str = "facebook/bart-large-mnli"
    hf_ner_model_name: str = "dslim/bert-base-NER"
    ...
    hf_reranker_weight: float = 0.35
    hf_reranker_batch_size: int = 8
    hf_reranker_max_length: int = 512
